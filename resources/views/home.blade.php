...
{{--            @endif--}}
            ...
            <div class="bg-Surface_0 p-2 w-fit rounded-md m-2 group/a">
                <div class="relative mx-auto my-2 w-32 h-32 border-Crust border-2 rounded-full ">
                    ...
                    <div
                        class="absolute left-0 top-0 w-full h-full inset-0 rounded-full group-hover/a:ring-Mauve group-hover/a:ring-2 animate-pulse"></div>
                </div>
                ...
                <ul class="flex flex-col gap-2 m-2">
                    <li class="flex flex-row group cursor-pointer">
                        <a href="mailto:contact@nynxz.com" class="flex flex-row">
                            <x-icons.email class="w-8 h-8 "/>
                            <span class="my-auto px-2 text-lg font-bold"> Email </span>
                        </a>
                    </li>
                    <li class="flex flex-row group cursor-pointer">
                        <a href="https://github.com/nynxz" class="flex flex-row" target="_">
                        <x-icons.github class="w-8 h-8 "/>
                    ...
                    <li class="flex flex-row group cursor-pointer">
                        ...
                        <x-icons.linkedin class="w-8 h-8 "/>
